      ...
      <div v-if="resoulist1.length > 0" class="newCollege_fors">
        ...
        >
          ...
          <div class="newCollege_for_title">
            <p style="margin-top: 8px; font-weight: bold; margin-left: 5px">
              {{ item.symbol }}
            </p>
          ...
          <div
            ...
            v-html="item.summary"
          ></div>
          <p style="margin: 15px 0; font-weight: bold; margin-left: 5px">
            {{ $t('newCommon2.text8') }}:{{ item.endTime }}
          </p>
          <button
            @click="GetMide()"
            style="background: #00ad88; color: #fff"
            class="newCollege_btn"
          >
            進行中
          </button>
        </div>
      </div>
      <div style="margin-left: 7%" v-else>暫無....</div>
    </div>
    <div class="newCollege">
      <p
        style="
      ...
      <div class="newCollege_fors" v-if="resoulist0.length > 0">
        ...
        >
          ...
          ></div>
          <p style="margin: 15px 0; font-weight: bold; margin-left: 5px">
            {{ $t('newCommon2.text7') }}:{{ item.createTime }}
          </p>
          <button
            @click="GetMide()"
