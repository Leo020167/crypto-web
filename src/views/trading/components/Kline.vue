    ...
    drawChart() {
      ...
      const widgetOptions = {
        ...
        overrides: {
          ...
          'mainSeriesProperties.candleStyle.upColor': 'rgb(204, 53, 53)',
          'mainSeriesProperties.candleStyle.downColor': '#41b37d',
          'mainSeriesProperties.candleStyle.drawWick': true,
          'mainSeriesProperties.candleStyle.wickUpColor': 'rgb(204, 53, 53)',
          'mainSeriesProperties.candleStyle.wickDownColor': '#41b37d',
          'mainSeriesProperties.candleStyle.barColorsOnPrevClose': !1,
          'mainSeriesProperties.candleStyle.drawBorder': true,
          'mainSeriesProperties.candleStyle.borderUpColor': 'rgb(204, 53, 53)',
          'mainSeriesProperties.candleStyle.borderDownColor': '#41b37d',
          ...
          'mainSeriesProperties.hollowCandleStyle.upColor': 'rgb(204, 53, 53)',
          'mainSeriesProperties.hollowCandleStyle.downColor': '#41b37d',
          'mainSeriesProperties.hollowCandleStyle.wickColor': '#737375',
          'mainSeriesProperties.haStyle.upColor': 'rgb(204, 53, 53)',
          'mainSeriesProperties.haStyle.downColor': '#41b37d',
          'mainSeriesProperties.haStyle.drawWick': !0,
          'mainSeriesProperties.haStyle.drawBorder': !0,
          'mainSeriesProperties.haStyle.borderUpColor': 'rgb(204, 53, 53)',
          'mainSeriesProperties.haStyle.borderDownColor': '#41b37d',
          'mainSeriesProperties.haStyle.barColorsOnPrevClose': !1,
          'mainSeriesProperties.barStyle.upColor': 'rgb(204, 53, 53)',
          'mainSeriesProperties.barStyle.downColor': '#41b37d',
