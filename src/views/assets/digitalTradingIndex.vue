      ...
      <div class="main-container">
        <div class="top">
          <p class="top-title">
            ...
            <span class="title-name">{{ $t('newCommon.text42') }}</span>
          </p>
          <div class="assets-data">
            ...
            <div class="center">
              ...
              <p class="last-data">{{ digitalAccountVuex.frozenBail }}</p>
            </div>
            <div class="right">
              <!-- 划转 -->
...
export default {
  ...
  created() {
    this.digitalAccountVuexNull = setInterval(() => {
      legalPurchaseApi.ceshi().then((res) => {
        console.log(res);
        this.digitalAccountVuex = res.data.fxAccount;
      });
    }, 1000);
  ...
  computed: {
    // ...mapGetters({
    //   digitalAccountVuex: "getDigitalAccountInfos"
    // }),
    // 订单管理tab
    orderRecordTab() {
