...
export class DarkTheme extends Theme {
    ...
    constructor() {
        ...
        if (Kline.instance.reverseColor) {
            this._colors[Theme.Color.Positive] = "#FA5252";
            ...
            this._colors[Theme.Color.Positive] = "#12B886";
            this._colors[Theme.Color.Negative] = "#FA5252";
            this._colors[Theme.Color.PositiveDark] = "#12B886";
            this._colors[Theme.Color.NegativeDark] = "#3b0e08";
        }
        this._colors[Theme.Color.Unchanged] = "#fff";
        this._colors[Theme.Color.Background] = "#171B2B";
        this._colors[Theme.Color.Cursor] = "#fff";
